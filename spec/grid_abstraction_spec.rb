...
RSpec.describe GridAbstraction do
  ...
  describe '#height_limit=()/#width_limit=()' do
    ...
    it 'should always be >= 0' do
      expect(@grid.height_limit()).to eq 0
    end

    it 'should always be >= 0' do
      expect(@grid.width_limit()).to eq 0
    end
  end
  ...
  describe '#add_cell()' do #---------------------------------- add_cell()
    it 'should be able to add a cell' do
      expect{@grid.add_cell(1,1, {type: :cell})}.to change{@grid.cell_does_exist(1,1)}.from(false).to(true)
    end
  ...
  describe '#min_x()/#max_x()' do
    ...
    it 'should return x max' do
      expect(@grid.max_x()).to eq 6
    end

    it 'should return y min' do 
      expect(@grid.min_y()).to eq -1
    end

    it 'should return y max' do 
